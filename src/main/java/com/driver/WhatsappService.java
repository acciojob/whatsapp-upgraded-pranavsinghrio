...
public class WhatsappService {
    ...
    HashMap<Group, List<Message>>groupMessageHashMap=new HashMap<>();
    HashMap<User, List<Message>>userMessageHashMap=new HashMap<>();
    ...
    public int sendMessage(Message message,User sender,Group group)throws Exception{
        ...
        else
        {
            List<Message> messages=new ArrayList<>();
            messages.add(message);
            userMessageHashMap.put(sender,messages);
        }
    ...
    public int removeUser(User user)throws Exception {
        ...
        int groupSize = 0;
        int messageCount = 0;
        int overallMessageCount = messages.size();
        ...
        if (userMessageHashMap.containsKey(user))
        {
            messageCount = userMessageHashMap.get(user).size() - 2;
